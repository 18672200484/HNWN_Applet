namespace CMCS.DumblyConcealer.Win
{
    partial class MDIParent
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tsmiOpenFrmAutoCupBoard = new System.Windows.Forms.ToolStripMenuItem();
			...
			// 
			// tsmiOpenFrmAutoCupBoard
			// 
			this.tsmiOpenFrmAutoCupBoard.Name = "tsmiOpenFrmAutoCupBoard";
			this.tsmiOpenFrmAutoCupBoard.Size = new System.Drawing.Size(213, 22);
			this.tsmiOpenFrmAutoCupBoard.Text = "08.存样柜接口";
			this.tsmiOpenFrmAutoCupBoard.Click += new System.EventHandler(this.tsmiOpenFrmAutoCupBoard_Click);
			// 
			// MDIParent
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem tsmiOpenFrmAutoCupBoard;
	}
}
