...
namespace CMCS.Monitor.Win.Frms
{
    public partial class FrmCarMonitor : MetroForm
    {
        ...
        void RequestData()
        {
            ...
            datas.Add(new HtmlDataItem("Infactory_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            #endregion
            ...
            datas.Add(new HtmlDataItem("Sample1_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            ...
            datas.Add(new HtmlDataItem("Sample2_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            ...
            datas.Add(new HtmlDataItem("Sample3_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            ...
            datas.Add(new HtmlDataItem("Weighter1_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            ...
            datas.Add(new HtmlDataItem("Weighter2_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            ...
            datas.Add(new HtmlDataItem("Weighter3_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            ...
            datas.Add(new HtmlDataItem("Weighter4_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            ...
            datas.Add(new HtmlDataItem("Outfactory_State5", commonDAO.GetSignalDataValue(machineCode, "读卡器_连接状态"), eHtmlDataItemType.json_data));
            #endregion
