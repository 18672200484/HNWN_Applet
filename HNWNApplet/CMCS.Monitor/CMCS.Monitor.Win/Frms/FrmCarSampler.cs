...
namespace CMCS.Monitor.Win.Frms
{
    public partial class FrmCarSampler : MetroForm
    {
        ...
        void RequestData()
        {
            ...
            datas.Add(new HtmlDataItem("机械采样机_采样编码", commonDAO.GetSignalDataValue(machineCode, "采样编码"), eHtmlDataItemType.svg_text));
            datas.Add(new HtmlDataItem("机械采样机_矿发量", commonDAO.GetSignalDataValue(machineCode, "矿发量"), eHtmlDataItemType.svg_text));
            datas.Add(new HtmlDataItem("机械采样机_采样时间", commonDAO.GetSignalDataValue(machineCode, "采样时间"), eHtmlDataItemType.svg_text));
            datas.Add(new HtmlDataItem("机械采样机_车牌号", commonDAO.GetSignalDataValue(machineCode, "车牌号"), eHtmlDataItemType.svg_text));
            datas.Add(new HtmlDataItem("机械采样机_采样点数", commonDAO.GetSignalDataValue(machineCode, "采样点数"), eHtmlDataItemType.svg_text));
