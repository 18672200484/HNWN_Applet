...
namespace CMCS.Monitor.Win.Frms
{
    public partial class FrmBuyFuelLoadToday : MetroForm
    {
        ...
        public void BindData()
        {
            ...
            List<CmcsBuyFuelTransport> list = Dbers.GetInstance().SelfDber.Entities<CmcsBuyFuelTransport>(" where InFactoryTime>=to_date('" + DateTime.Now.ToString("yyyy-MM-dd") + "','yyyy-mm-dd') order by InFactoryTime desc");
