        ...
        protected override bool Execute(string name, CefV8Value obj, CefV8Value[] arguments, out CefV8Value returnValue, out string exception)
        {
            ...
            switch (paramSampler)
            {
                ...
                case "Sample2_Down2":
                    ...
                    break;
                case "Sample3_Up1":
                    SendControlCmd(GlobalVars.MachineCode_QC_JxSampler_3, "Gate1Up");
                    break;
                case "Sample3_Down1":
                    SendControlCmd(GlobalVars.MachineCode_QC_JxSampler_3, "Gate1Down");
                    break;
                case "Sample3_Up2":
                    SendControlCmd(GlobalVars.MachineCode_QC_JxSampler_3, "Gate2Up");
                    break;
                case "Sample3_Down2":
                    SendControlCmd(GlobalVars.MachineCode_QC_JxSampler_3, "Gate2Down");
                    break;
                #endregion
