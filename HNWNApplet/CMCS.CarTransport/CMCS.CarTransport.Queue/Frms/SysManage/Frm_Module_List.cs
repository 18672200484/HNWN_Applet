...
namespace CMCS.CarTransport.Queue.Frms.SysManage
{
    public partial class Frm_Module_List : MetroAppForm
    {
        ...
        private void Frm_Module_List_Load(object sender, EventArgs e)
        {
            ...
            clmDelete.Visible = queuerDAO.CheckPower(this.GetType().ToString(), "04", GlobalVars.LoginUser);
            ...
            clmDeleteRes.Visible = queuerDAO.CheckPower(this.GetType().ToString(), "04", GlobalVars.LoginUser);
        ...
        public void BindData()
        {
            ...
            List<SysModule> list = Dbers.GetInstance().SelfDber.Entities<SysModule>(tempSqlWhere + "  order by Moduleno ");
