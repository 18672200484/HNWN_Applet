...
namespace CMCS.CarTransport.Queue.Frms.Sys
{
    partial class FrmMainFrame
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnOpenGoodsPlan = new DevComponents.DotNetBar.ButtonItem();
			this.btnOpenSupplierAssignSampler = new DevComponents.DotNetBar.ButtonItem();
			this.timer_CurrentTime = new System.Windows.Forms.Timer(this.components);
			this.OpenCMEquipMent = new DevComponents.DotNetBar.ButtonItem();
    ...
    "t";
            ...
            this.btnOpenGoodsPlan,
            this.btnOpenSupplierAssignSampler,
            this.OpenCMEquipMent});
			...
			this.btnOpenMineLoad.Visible = false;
			...
			// btnOpenGoodsPlan
			// 
			this.btnOpenGoodsPlan.GlobalItem = false;
			this.btnOpenGoodsPlan.Name = "btnOpenGoodsPlan";
			this.btnOpenGoodsPlan.Tag = "CMCS.CarTransport.Queue.Frms.BaseInfo.GoodsPlan.FrmGoodsPlan_List";
			this.btnOpenGoodsPlan.Text = "其他物资计划";
			this.btnOpenGoodsPlan.Click += new System.EventHandler(this.btnOpenGoodsPlan_Click);
			// 
			// btnOpenSupplierAssignSampler
			// 
			this.btnOpenSupplierAssignSampler.GlobalItem = false;
			this.btnOpenSupplierAssignSampler.Name = "btnOpenSupplierAssignSampler";
			this.btnOpenSupplierAssignSampler.Tag = "CMCS.CarTransport.Queue.Frms.BaseInfo.SupplierAssignSampler.FrmSupplierAssignSamp" +
    "ler_List";
			this.btnOpenSupplierAssignSampler.Text = "供应商分配采样机";
			this.btnOpenSupplierAssignSampler.Click += new System.EventHandler(this.btnOpenSupplierAssignSampler_Click);
			// 
			// timer_CurrentTime
			// 
			...
			// OpenCMEquipMent
			// 
			this.OpenCMEquipMent.GlobalItem = false;
			this.OpenCMEquipMent.Name = "OpenCMEquipMent";
			this.OpenCMEquipMent.Text = "设备管理";
			this.OpenCMEquipMent.Click += new System.EventHandler(this.OpenCMEquipMent_Click);
			// 
			// FrmMainFrame
			// 
        ...
        private DevComponents.DotNetBar.ButtonItem btnOpenGoodsPlan;
        private DevComponents.DotNetBar.ButtonItem btnOpenSupplierAssignSampler;
		private DevComponents.DotNetBar.ButtonItem OpenCMEquipMent;
	}
}
